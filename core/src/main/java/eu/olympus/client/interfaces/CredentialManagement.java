...
public interface CredentialManagement {
  ...
  //  boolean combineAndStoreCredential(Map<Integer,PSCredential> credentialShares);
    ...
    /**
     * Sets the current revocation credential.
     * @param revocationCredential A revocation credential.
     */
    void setRevocationCredential(PSCredential revocationCredential);
